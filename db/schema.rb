...
ActiveRecord::Schema.define(version: 20160715131818) do
  ...
  add_index "recruits", ["activity_id"], name: "index_recruits_on_activity_id", using: :btree
  add_index "recruits", ["opu_id"], name: "index_recruits_on_opu_id", using: :btree
