...
SimpleForm.setup do |config|
  ...
  config.wrappers :apply_horizontal_form, tag: 'div', class: 'form-group clearfix', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :push_horizontal_form, tag: 'div', class: 'form-group clearfix', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
    ...
    b.wrapper tag: 'div', class: 'col-sm-12 no-padding' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
  ...
  config.wrappers :apply_form, tag: 'div', class: 'form-group clearfix', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-7 no-padding' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
